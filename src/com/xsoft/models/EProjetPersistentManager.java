...
public class EProjetPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EProjet";
	...
	private EProjetPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EProjetPersistentManager();
		}
